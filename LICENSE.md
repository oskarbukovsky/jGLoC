...
###  This project uses a fork of the "Don't Be a Jerk" License created by CoFH
...
Essentially, take this and learn from it! Create addons that depend on it! If you see something we can improve, tell me. Submit a Pull Request. The one catch: don't steal! A lot of effort has gone into this, and if you were to take this and call it your own, you'd basically be a big jerk.
